...
private:
    ...
    public:
        ...
        VOID GetOffsetsDownloaderWidgets()
        {
            ...
            const char* Client_Dll_Json = "https://github.com/a2x/cs2-dumper/raw/main/output/client_dll.json";
        ...
        VOID GetConfigWidgets()
        {
            ...
            if (ImGui::Button("Search/Refresh JSON Files"))
            {
                ScanDirectoryForJsonFiles("configs");
            }
